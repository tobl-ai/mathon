...
const FLOW_STEPS = [
  ...
  { step: "4", title: "결과 미리보기", desc: "생성된 문제 + 해설 확인, 개별 재생성" },
  { step: "5", title: "HWP 다운로드", desc: "수식 포함 편집 가능한 HWP 파일 다운로드" },
];

const SCENARIOS = [
  {
    title: "시험지 제작",
    desc: "수업에서 다룬 10개 문제 업로드 → 각 2개 유사 문제 (총 20문제) → 난이도 \"비슷하게\" → HWP 다운로드",
  },
  {
    title: "심화 학습지",
    desc: "상위권 학생용 5개 문제 → \"더 어렵게\" 옵션으로 각 3개 생성 → HWP 다운로드",
  },
  {
    title: "오답 복습지",
